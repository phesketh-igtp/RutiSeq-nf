...
**RutiSeq-nf** is designed for the classification, clustering, and SNP barcoding of Mycobacterium tuberculosis genomes to support outbreak surveillance. The pipeline is composed of four sub-workflows: (1) single genome analysis, (2) pairwise genome comparisons, (3) summary reporting, and (4) cluster barcoding.
