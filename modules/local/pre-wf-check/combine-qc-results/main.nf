process COMBINE_QC_RESULTS {
    ...
    output:
    path "${runID}_${timestamp}_combined_qc_results.csv"
    ...
    echo -e "RunID\tSampleID\torig.R1_reads\torig.R1_aveQ\torig.R2_reads\torig.R1_aveQ\torig.MTB_perc\tfilt.R1_reads\tfilt.R1_aveQ\tfilt.R2_reads\tfilt.R1_aveQ" > ${runID}_${timestamp}_combined_qc_results.csv
